"""test_sidewinder.py - test binary tree methods
Copyright 2022 by Eric Conrad

USAGE

    usage: test_sidewinder.py [-h] [-d DIM DIM]

    Test sidewinder maze algorithm.
...
if __name__ == '__main__':
    ...
    rows, cols = args.dim
        ...
        # --------- TESTING STARTS HERE ----------
    print('Test 1)', 'spanning tree using the sidewinder algorithm')
